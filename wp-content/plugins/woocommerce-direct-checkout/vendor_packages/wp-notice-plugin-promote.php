...
if ( class_exists( 'QuadLayers\\WP_Notice_Plugin_Promote\\Load' ) ) {
	...
	define( 'QLWCDC_PROMOTE_CROSS_INSTALL_1_URL', 'https://quadlayers.com/portfolio/woocommerce-checkout-manager/?utm_source=qlwcdc_admin' );
	/**
	 * Notice cross sell 2
	 */
	...
	define( 'QLWCDC_PROMOTE_CROSS_INSTALL_2_URL', 'https://quadlayers.com/portfolio/perfect-woocommerce-brands/?utm_source=qlwcdc_admin' );
